                            ...
                            <div class="bg-soft-primary">
                                <div class="row">
                                    ...
                                    <div class="col-5 align-self-end">
                                        ...
                                        <img src="assets/images/logo/favicon.ico" alt="" class="img-fluid" style="height: 120px">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-box">
                        ...
                        <div class="card-body">
                            <div class="alert alert-danger" style="text-align: center;">
                                <strong>Ohhh !!!</strong> Username & Password Wrong . . .
                            </div>
                        </div>
                    </div>
                </div>
...
?>
                            <div class="mt-5 text-center">
                                ...
                                <a href="auth-regi.php">Register Now !!!</a>
                            </div>
